...
var IdentifyWhitelist map[string]string
var Total map[string]map[string]string
...
func LoadConfig() {
	...
	IdentifyWhitelist = make(map[string]string)
	Hostlist = make(map[string]string)
	Total = make(map[string]map[string]string)
	...
	Total["Config"] = Config
	Total["DatabaseMap"] = DatabaseMap
	Total["Hostlist"] = Hostlist
	Total["IdentifyWhitelist"] = IdentifyWhitelist
}
